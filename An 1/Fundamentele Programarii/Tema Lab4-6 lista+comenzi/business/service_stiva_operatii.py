...
def undo_concurenti_service(concurenti, stiva_operatii):
    ...
    :return:
    """
    from business.service_concurenti import sterge_concurent_dupa_id_service, \
        sterge_ultimul_scor_concurent_dupa_id_service, modifica_concurent_service, \
        modifica_mai_multi_concurenti_service, modifica_scor_concurent_service
