...
void testMaxim(){
    AB ab;
    assert(ab.maxim() == -1); // arborele este vid

    AB a1(1), a2(2), a3(3);
    a3.adaugaSubSt(a1);
    a3.adaugaSubDr(a2);
    //tiparesteABPreordine(a3); // tiparim arborele pentru verificare
    AB a4(ab, 4, a3);
    assert(a4.maxim() == 4); // maximul este 4
    AB a5(5);
    a4.adaugaSubDr(a5);
    assert(a4.maxim() == 5); // maximul este acum 5
}
