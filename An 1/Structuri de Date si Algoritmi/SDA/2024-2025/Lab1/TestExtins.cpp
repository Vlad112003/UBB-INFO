...
void testAllExtins() {
	testCreeaza();
    cout<<"test creeaza passed"<<endl;
	testAdauga();
    cout<<"test adauga passed"<<endl;
	testSterge();
    cout<<"test sterge passed"<<endl;
	testIterator();
    cout<<"test iterator passed"<<endl;
	testQuantity();
    cout<<"test quantity passed"<<endl;
	testExceptii();
    cout<<"test exceptii passed"<<endl;
}
