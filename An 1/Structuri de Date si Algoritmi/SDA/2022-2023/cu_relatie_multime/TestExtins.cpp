...
void testAdauga() {
	...
	cout << "succes valori ff mari si mici\n ";
}
...
void testSterge() {
	...
	assert(m.dim() == 0);
	//printM(m);
	//cout << "Sters din multime vida cu succes!\n";
	...
	//printM(m);
	//cout << "Adauga numere pare stergea lor, cu succes\n";

	for (int i = -100; i <= 100; i = i + 2) { //adaugam elemente din 2 in 2
		m.adauga(i);
	}
	//printM(m);
	//cout << "adauga elem din 2 in 2 cu succes\n";
	...
	assert(m.dim() == 1);
	//printM(m);
	//cout << "Stergere in ordine inversa cu succes\n";
	...
	//printM(m);
	//cout << "adauga de 5 ori fiecare cu succes\n";
	...
	assert(m.dim() == 0);
	//cout << "Stergere elem existente si inexistente cu succes!\n";
...
void testAllExtins() {
	...
	cout << "succes sterge\n";
	testIterator();
	cout << "succes iterator\n";
	testQuantity();
	cout << "succes quantity\n";
