...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DO = 12,                        /* DO  */
  YYSYMBOL_CAT_TIMP = 13,                  /* CAT_TIMP  */
  YYSYMBOL_EXECUTA = 14,                   /* EXECUTA  */
  YYSYMBOL_SF_CAT_TIMP = 15,               /* SF_CAT_TIMP  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INT", "MAIN", "FLOAT",
  "CHAR", "STRING", "CIN", "COUT", "IF", "WHILE", "DO", "CAT_TIMP",
  "EXECUTA", "SF_CAT_TIMP", "LPAREN", "RPAREN", "LBRACE", "RBRACE",
  "INPUT", "OUTPUT", "EQ", "NEQ", "GE", "LE", "GT", "LT", "ASSIGN", "INC",
  "DEC", "PLUS", "MINUS", "MULT", "DIV", "MOD", "SEMICOLON", "COMMA",
  "STRING_LITERAL", "CONSTANT", "IDENTIFIER", "$accept", "program",
...
#line 1192 "parser.tab.c"
  ...
  case 13: /* statement: DO  */
#line 42 "parser.y"
         { printf("Keyword: do\n"); }
#line 1198 "parser.tab.c"
    break;

  case 14: /* statement: CAT_TIMP  */
#line 43 "parser.y"
               { printf("Keyword: cat timp\n"); }
#line 1204 "parser.tab.c"
    break;

  case 15: /* statement: EXECUTA  */
#line 44 "parser.y"
              { printf("Keyword: executa\n"); }
#line 1210 "parser.tab.c"
    break;

  case 16: /* statement: SF_CAT_TIMP  */
#line 45 "parser.y"
                  { printf("Keyword: sf cat timp\n"); }
#line 1216 "parser.tab.c"
    break;

  case 17: /* statement: LPAREN  */
#line 46 "parser.y"
             { printf("Symbol: (\n"); }
#line 1222 "parser.tab.c"
    break;

  case 18: /* statement: RPAREN  */
#line 47 "parser.y"
             { printf("Symbol: )\n"); }
#line 1228 "parser.tab.c"
    break;

  case 19: /* statement: LBRACE  */
#line 48 "parser.y"
             { printf("Symbol: {\n"); }
#line 1234 "parser.tab.c"
    break;

  case 20: /* statement: RBRACE  */
#line 49 "parser.y"
             { printf("Symbol: }\n"); }
#line 1240 "parser.tab.c"
    break;

  case 21: /* statement: INPUT  */
#line 50 "parser.y"
            { printf("Symbol: >>\n"); }
#line 1246 "parser.tab.c"
    break;

  case 22: /* statement: OUTPUT  */
#line 51 "parser.y"
             { printf("Symbol: <<\n"); }
#line 1252 "parser.tab.c"
    break;

  case 23: /* statement: EQ  */
#line 52 "parser.y"
         { printf("Symbol: ==\n"); }
#line 1258 "parser.tab.c"
    break;

  case 24: /* statement: NEQ  */
#line 53 "parser.y"
          { printf("Symbol: !=\n"); }
#line 1264 "parser.tab.c"
    break;

  case 25: /* statement: GE  */
#line 54 "parser.y"
         { printf("Symbol: >=\n"); }
#line 1270 "parser.tab.c"
    break;

  case 26: /* statement: LE  */
#line 55 "parser.y"
         { printf("Symbol: <=\n"); }
#line 1276 "parser.tab.c"
    break;

  case 27: /* statement: GT  */
#line 56 "parser.y"
         { printf("Symbol: >\n"); }
#line 1282 "parser.tab.c"
    break;

  case 28: /* statement: LT  */
#line 57 "parser.y"
         { printf("Symbol: <\n"); }
#line 1288 "parser.tab.c"
    break;

  case 29: /* statement: ASSIGN  */
#line 58 "parser.y"
             { printf("Symbol: =\n"); }
#line 1294 "parser.tab.c"
    break;

  case 30: /* statement: INC  */
#line 59 "parser.y"
          { printf("Symbol: ++\n"); }
#line 1300 "parser.tab.c"
    break;

  case 31: /* statement: DEC  */
#line 60 "parser.y"
          { printf("Symbol: --\n"); }
#line 1306 "parser.tab.c"
    break;

  case 32: /* statement: PLUS  */
#line 61 "parser.y"
           { printf("Symbol: +\n"); }
#line 1312 "parser.tab.c"
    break;

  case 33: /* statement: MINUS  */
#line 62 "parser.y"
            { printf("Symbol: -\n"); }
#line 1318 "parser.tab.c"
    break;

  case 34: /* statement: MULT  */
#line 63 "parser.y"
           { printf("Symbol: *\n"); }
#line 1324 "parser.tab.c"
    break;

  case 35: /* statement: DIV  */
#line 64 "parser.y"
          { printf("Symbol: /\n"); }
#line 1330 "parser.tab.c"
    break;

  case 36: /* statement: MOD  */
#line 65 "parser.y"
          { printf("Symbol: %\n"); }
...
#line 1342 "parser.tab.c"
  ...
  case 38: /* statement: COMMA  */
#line 67 "parser.y"
            { printf("Symbol: ,\n"); }
#line 1348 "parser.tab.c"
    break;

  case 39: /* statement: STRING_LITERAL  */
#line 68 "parser.y"
                     { printf("String literal: %s\n", (yyvsp[0].str)); free((yyvsp[0].str)); }
#line 1354 "parser.tab.c"
    break;

  case 40: /* statement: CONSTANT  */
#line 69 "parser.y"
               { printf("Constant: %s\n", (yyvsp[0].str)); free((yyvsp[0].str)); }
#line 1360 "parser.tab.c"
    break;

  case 41: /* statement: IDENTIFIER  */
#line 70 "parser.y"
                 { printf("Identifier: %s\n", (yyvsp[0].str)); free((yyvsp[0].str)); }
