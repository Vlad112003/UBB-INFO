...
<div class ="container">
    ...
    <table border="1">
        ...
        if ($username != "prof") {
            $sql = "SELECT st.nume as 'nume', sb.nume as 'denumire', n.nota as nota FROM students st, subjects sb, notare n WHERE st.id = n.idS and sb.id = n.idD and st.username = '$username' ";
