...
//        assert(friends1.getStatus().equals(pending));
//
//        friends1.setStatus(accepted);
//        assert(friends1.getStatus().equals(accepted));
//
...
//        Repository repoMessages = new InMemoryRepository();
...
//        Service serv = new Service(repoUser, userValidator, repoFriends, friendshipValidator, repoMessages, messageValidator);
//
//        User user1 = new User("Vled", "Vled", vledEmail, "vled");
//
//        serv.addUser(user1);
...
//
//        serv.sendMessage(new User("Vled", "Vled", vledEmail, "vled"), new User("Vled2", "Vled2", "2"+vledEmail, "vled2"), "message");
//
//
//
//    }
