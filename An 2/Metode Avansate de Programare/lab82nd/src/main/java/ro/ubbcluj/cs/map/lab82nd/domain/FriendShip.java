...
//    private LocalDate friendsFromDate;
    ...
    public FriendShip(UUID id, User user1, User user2, LocalDateTime friendsFrom, FriendRequest request){
        this.user1 = user1;
        this.user2 = user2;
        this.setId(id);
        this.friendsFrom = friendsFrom;
...
//    }
    ...
    public FriendShip(Optional u1, Optional u2, LocalDateTime friendsFrom, String status){
        this.user1 = (User) u1.get();
        this.user2 = (User) u2.get();
        this.setId(UUID.randomUUID());
        this.friendsFrom = friendsFrom;
        this.request = FriendRequest.valueOf(status);
    }
...
//    }
     ...
     */
    public void setStatus(FriendRequest request) {
        this.request = request;
    }
