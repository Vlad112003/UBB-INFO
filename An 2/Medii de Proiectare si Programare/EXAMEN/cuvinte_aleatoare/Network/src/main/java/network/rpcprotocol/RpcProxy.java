...
public class RpcProxy implements IService {
    ...
    public Game getGameById(Integer id) throws Exception {
        Request request = new Request.Builder().type(RequestType.GET_GAME).data(id).build();
        sendRequest(request);
        Response response = readResponse();
        switch (response.type()) {
            case OK -> {
    ...
    public Configuration getConfById(Integer id) throws Exception {
        Request request = new Request.Builder().type(RequestType.GET_CONF).data(id).build();
        sendRequest(request);
        Response response = readResponse();
        switch (response.type()) {
            case OK -> {
