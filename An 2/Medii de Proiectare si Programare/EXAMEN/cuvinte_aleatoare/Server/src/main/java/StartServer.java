import persistence.cuvinte.CuvinteRepository;
...
public class StartServer {
    ...
    public static void main(String[] args) {
        ...
        var p=playerRepository.findByUsername("ion");
        ...
        ICuvinteRepository cuvinteRepository=new CuvinteRepository(serverProperties);

        IService service = new ServiceImplementation(playerRepository, configurationRepository, gameRepository,cuvinteRepository);
