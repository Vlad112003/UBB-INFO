...
namespace lab
{
    ...
    {
        SqlConnection cs = new SqlConnection("Data Source=DESKTOP-7Q5PB5U\\SQLEXPRESS;Initial Catalog=SGBD_l1;Integrated Security=True");
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                int Id_Adresa = Convert.ToInt32(selectedRow.Cells["Id_Adresa"].Value);

                using (SqlCommand command = new SqlCommand("SELECT * FROM Client WHERE Id_Adresa = @Id_Adresa", cs))
                {
                    command.Parameters.AddWithValue("@Id_Adresa", Id_Adresa);
                    dsC.Clear();
        ...
        private void adauga_Click(object sender, EventArgs e)
        {
            ...
            int Id_Adresa = Convert.ToInt32(dataGridView1.SelectedRows[0].Cells["Id_Adresa"].Value);
        ...
        private void sterge_Click(object sender, EventArgs e)
        {
            ...
            da.DeleteCommand = new SqlCommand("Delete from Client where Id_Client = @Id_Client;", cs);

            da.DeleteCommand.Parameters.Add("@Id_Client", SqlDbType.Int).Value = dsC.Tables[0].Rows[dataGridView2.CurrentCell.RowIndex][0];
        ...
        private void update_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlCommand cmd = new SqlCommand("UPDATE Client SET Nume = @Nume, Email = @Email WHERE Id_Client = @Id_Client", cs))
                {
